<?php /*a:2:{s:102:"/Users/ding/Documents/GSB 3/4.15/label-00896-GSB-0415/frontend-admin/app/view/admin/message/index.html";i:1776232727;s:109:"/Users/ding/Documents/GSB 3/4.15/label-00896-GSB-0415/frontend-admin/app/view/admin/../admin/layout/base.html";i:1776232727;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    ...
    <title>留言管理 - <?php echo htmlentities((string) $site_name); ?></title>
...
<div class="filter-card">
    <form class="row g-3 align-items-end" method="get">
        <div class="col-auto">
            <input type="text" class="form-control" name="keyword" value="<?php echo htmlentities((string) (isset($keyword) && ($keyword !== '')?$keyword:'')); ?>" placeholder="姓名/邮箱/内容">
        </div>
        <div class="col-auto">
            <select class="form-select" name="is_read">
                <option value="">全部状态</option>
                <option value="0" <?php if(isset($is_read) && $is_read === '0'): ?>selected<?php endif; ?>>未读</option>
                <option value="1" <?php if(isset($is_read) && $is_read === '1'): ?>selected<?php endif; ?>>已读</option>
            </select>
        </div>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo htmlentities((string) $item['name']); ?></td>
                    <td>
                        <?php if($item['email']): ?><div class="small"><?php echo htmlentities((string) $item['email']); ?></div><?php endif; if($item['phone']): ?><div class="small"><?php echo htmlentities((string) $item['phone']); ?></div><?php endif; ?>
                    </td>
                    <td><?php echo htmlentities((string) mb_substr($item['content'],0,40,'utf-8')); ?></td>
                    <td>
                        <?php if($item['is_read'] == 1): ?>
                        <span class="status-tag success">已读</span>
                        <?php else: ?>
                        <span class="status-tag danger">未读</span>
                        <?php endif; ?>
                    </td>
                    ...
                    <td class="action-btns">
                        <button class="btn btn-sm btn-outline-primary" onclick="viewMessage(<?php echo htmlentities((string) $item['id']); ?>)">查看</button>
                        <button class="btn btn-sm btn-outline-danger" onclick="confirmDelete('/admin/message/delete/<?php echo htmlentities((string) $item['id']); ?>', $(this).closest('tr'))">删除</button>
                    </td>
                </tr>
        ...
        <div class="d-flex align-items-center">
            ...
            <ul class="pagination pagination-sm mb-0">
                ...
                <li class="page-item <?php if($currentPage <= 1): ?>disabled<?php endif; ?>">
                    <a class="page-link" href="<?php echo url('/admin/message', array_merge(request()->get(), ['page' => $currentPage - 1])); ?>">上一页</a>
                </li>
                <?php if($lastPage <= 7): $__FOR_START_2002088608__=1;$__FOR_END_2002088608__=$lastPage + 1;for($i=$__FOR_START_2002088608__;$i < $__FOR_END_2002088608__;$i+=1){ ?>
                <li class="page-item <?php if($currentPage == $i): ?>active<?php endif; ?>">
                    <a class="page-link" href="<?php echo url('/admin/message', array_merge(request()->get(), ['page' => $i])); ?>"><?php echo htmlentities((string) $i); ?></a>
                </li>
                <?php } else: if($currentPage <= 4): $__FOR_START_750109512__=1;$__FOR_END_750109512__=6;for($i=$__FOR_START_750109512__;$i < $__FOR_END_750109512__;$i+=1){ ?>
                <li class="page-item <?php if($currentPage == $i): ?>active<?php endif; ?>">
                    <a class="page-link" href="<?php echo url('/admin/message', array_merge(request()->get(), ['page' => $i])); ?>"><?php echo htmlentities((string) $i); ?></a>
                </li>
                <?php } ?>
                ...
                <li class="page-item">
                    <a class="page-link" href="<?php echo url('/admin/message', array_merge(request()->get(), ['page' => $lastPage])); ?>"><?php echo htmlentities((string) $lastPage); ?></a>
                </li>
                <?php elseif($currentPage >= $lastPage - 3): ?>
                <li class="page-item">
                    <a class="page-link" href="<?php echo url('/admin/message', array_merge(request()->get(), ['page' => 1])); ?>">1</a>
                </li>
                <li class="page-item disabled"><span class="page-link">...</span></li>
                <?php $__FOR_START_1752369724__=$lastPage - 4;$__FOR_END_1752369724__=$lastPage + 1;for($i=$__FOR_START_1752369724__;$i < $__FOR_END_1752369724__;$i+=1){ ?>
                <li class="page-item <?php if($currentPage == $i): ?>active<?php endif; ?>">
                    <a class="page-link" href="<?php echo url('/admin/message', array_merge(request()->get(), ['page' => $i])); ?>"><?php echo htmlentities((string) $i); ?></a>
                </li>
                <?php } else: ?>
                ...
                <li class="page-item disabled"><span class="page-link">...</span></li>
                <?php $__FOR_START_724920027__=$currentPage - 1;$__FOR_END_724920027__=$currentPage + 2;for($i=$__FOR_START_724920027__;$i < $__FOR_END_724920027__;$i+=1){ ?>
                <li class="page-item <?php if($currentPage == $i): ?>active<?php endif; ?>">
                    <a class="page-link" href="<?php echo url('/admin/message', array_merge(request()->get(), ['page' => $i])); ?>"><?php echo htmlentities((string) $i); ?></a>
                </li>
                <?php } ?>
                ...
                <li class="page-item <?php if($currentPage >= $lastPage): ?>disabled<?php endif; ?>">
                    <a class="page-link" href="<?php echo url('/admin/message', array_merge(request()->get(), ['page' => $currentPage + 1])); ?>">下一页</a>
                </li>
            </ul>
            </nav>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row mb-3">
                    ...
                    <div class="col-8">
                        <div id="viewName" class="fw-medium"></div>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-4">
                ...
                <div class="row mb-3">
                    <div class="col-4">
                        <label class="form-label text-muted">公司</label>
                    </div>
                    <div class="col-8">
                ...
                <div class="row mb-3">
                    <div class="col-4">
                        <label class="form-label text-muted">主题</label>
                    </div>
                    <div class="col-8">
                ...
                <div class="mb-3">
                    <label class="form-label text-muted">留言内容</label>
                    <div id="viewContent" class="p-3 bg-light rounded" style="white-space:pre-wrap;min-height:80px;"></div>
                </div>
                <div class="row mb-0">
                    <div class="col-4">
                    ...
                    <div class="col-8">
                        <div id="viewTime" class="text-muted"></div>
                    </div>
                </div>
            </div>
...
viewModalEl.addEventListener('hidden.bs.modal', function () {
    ...
    // 关闭弹窗后更新当前行的状态为已读
    if (currentViewId) {
        var $row = $('button[onclick*="viewMessage(' + currentViewId + ')"]').closest('tr');
        $row.find('.status-tag.danger').removeClass('danger').addClass('success').text('已读');
        currentViewId = null;
    }
});
...
function viewMessage(id) {
    currentViewId = id;
    $.get('/admin/message/view', {id: id}, function(res) {
        if (res.code === 1) {
            var d = res.data;
            $('#viewName').text(d.name || '-');
            $('#viewContact').html((d.email ? d.email + '<br>' : '') + (d.phone || ''));
            $('#viewCompany').text(d.company || '-');
            $('#viewSubject').text(d.subject || '-');
            $('#viewContent').text(d.content || '-');
            $('#viewTime').text(d.created_at || '-');
            viewModal.show();
        } else {
            showToast(res.msg, 'error');
        }
