<?php /*a:2:{s:99:"/Users/ding/Documents/GSB 3/4.15/label-00896-GSB-0415/frontend-admin/app/view/admin/case/index.html";i:1776232727;s:109:"/Users/ding/Documents/GSB 3/4.15/label-00896-GSB-0415/frontend-admin/app/view/admin/../admin/layout/base.html";i:1776232727;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    ...
    <title>案例管理 - <?php echo htmlentities((string) $site_name); ?></title>
...
<div class="filter-card">
    <form class="row g-3 align-items-end" method="get">
        <div class="col-auto">
            <input type="text" class="form-control" name="keyword" value="<?php echo htmlentities((string) (isset($keyword) && ($keyword !== '')?$keyword:'')); ?>" placeholder="搜索案例标题">
        </div>
        <div class="col-auto">
            <select class="form-select" name="status">
                <option value="">全部状态</option>
                <option value="1" <?php if(isset($status) && $status === '1'): ?>selected<?php endif; ?>>已发布</option>
                <option value="0" <?php if(isset($status) && $status === '0'): ?>selected<?php endif; ?>>草稿</option>
            </select>
        </div>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo htmlentities((string) mb_substr($item['title'],0,30,'utf-8')); ?></td>
                    <td><?php echo htmlentities((string) (isset($item['client']) && ($item['client'] !== '')?$item['client']:'-')); ?></td>
                    <td>
                        <?php if($item['status'] == 1): ?>
                        <span class="status-tag success">已发布</span>
                        <?php else: ?>
                        <span class="status-tag danger">草稿</span>
                        <?php endif; ?>
                    </td>
                    ...
                    <td class="action-btns">
                        ...
                        <button class="btn btn-sm btn-outline-<?php if($item['status'] == 1): ?>warning<?php else: ?>success<?php endif; ?>" onclick="toggleStatus('/admin/case/status/<?php echo htmlentities((string) $item['id']); ?>', $(this))"><?php if($item['status'] == 1): ?>下架<?php else: ?>发布<?php endif; ?></button>
                        <button class="btn btn-sm btn-outline-danger" onclick="confirmDelete('/admin/case/delete/<?php echo htmlentities((string) $item['id']); ?>', $(this).closest('tr'))">删除</button>
                    </td>
                </tr>
        ...
        <div class="d-flex align-items-center">
            ...
            <ul class="pagination pagination-sm mb-0">
                ...
                <li class="page-item <?php if($currentPage <= 1): ?>disabled<?php endif; ?>">
                    <a class="page-link" href="<?php echo url('/admin/case', array_merge(request()->get(), ['page' => $currentPage - 1])); ?>">上一页</a>
                </li>
                <?php if($lastPage <= 7): $__FOR_START_1013893917__=1;$__FOR_END_1013893917__=$lastPage + 1;for($i=$__FOR_START_1013893917__;$i < $__FOR_END_1013893917__;$i+=1){ ?>
                <li class="page-item <?php if($currentPage == $i): ?>active<?php endif; ?>">
                    <a class="page-link" href="<?php echo url('/admin/case', array_merge(request()->get(), ['page' => $i])); ?>"><?php echo htmlentities((string) $i); ?></a>
                </li>
                <?php } else: if($currentPage <= 4): $__FOR_START_96649078__=1;$__FOR_END_96649078__=6;for($i=$__FOR_START_96649078__;$i < $__FOR_END_96649078__;$i+=1){ ?>
                <li class="page-item <?php if($currentPage == $i): ?>active<?php endif; ?>">
                    <a class="page-link" href="<?php echo url('/admin/case', array_merge(request()->get(), ['page' => $i])); ?>"><?php echo htmlentities((string) $i); ?></a>
                </li>
                <?php } ?>
                ...
                <li class="page-item">
                    <a class="page-link" href="<?php echo url('/admin/case', array_merge(request()->get(), ['page' => $lastPage])); ?>"><?php echo htmlentities((string) $lastPage); ?></a>
                </li>
                <?php elseif($currentPage >= $lastPage - 3): ?>
                <li class="page-item">
                    <a class="page-link" href="<?php echo url('/admin/case', array_merge(request()->get(), ['page' => 1])); ?>">1</a>
                </li>
                <li class="page-item disabled"><span class="page-link">...</span></li>
                <?php $__FOR_START_223357553__=$lastPage - 4;$__FOR_END_223357553__=$lastPage + 1;for($i=$__FOR_START_223357553__;$i < $__FOR_END_223357553__;$i+=1){ ?>
                <li class="page-item <?php if($currentPage == $i): ?>active<?php endif; ?>">
                    <a class="page-link" href="<?php echo url('/admin/case', array_merge(request()->get(), ['page' => $i])); ?>"><?php echo htmlentities((string) $i); ?></a>
                </li>
                <?php } else: ?>
                ...
                <li class="page-item disabled"><span class="page-link">...</span></li>
                <?php $__FOR_START_84615875__=$currentPage - 1;$__FOR_END_84615875__=$currentPage + 2;for($i=$__FOR_START_84615875__;$i < $__FOR_END_84615875__;$i+=1){ ?>
                <li class="page-item <?php if($currentPage == $i): ?>active<?php endif; ?>">
                    <a class="page-link" href="<?php echo url('/admin/case', array_merge(request()->get(), ['page' => $i])); ?>"><?php echo htmlentities((string) $i); ?></a>
                </li>
                <?php } ?>
                ...
                <li class="page-item <?php if($currentPage >= $lastPage): ?>disabled<?php endif; ?>">
                    <a class="page-link" href="<?php echo url('/admin/case', array_merge(request()->get(), ['page' => $currentPage + 1])); ?>">下一页</a>
                </li>
            </ul>
            </nav>
        </div>
    ...
    <div class="modal-dialog modal-dialog-centered" style="max-width:500px;">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalTitle">新增案例</h5>
            ...
            <form id="editForm">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="client" id="editClient">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label class="form-label">案例详情 <span class="text-danger">*</span></label>
                        <textarea class="form-control" name="content" id="editContent" rows="6" required></textarea>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label">排序</label>
                            <input type="number" class="form-control" name="sort" id="editSort" value="0" min="0">
                        </div>
                        <div class="col-md-6 mb-3">
...
function openAdd() {
    $('#modalTitle').text('新增案例');
    $('#editForm')[0].reset();
    $('#editId').val('');
}

function openEdit(id) {
    $('#modalTitle').text('编辑案例');
    $.get('/admin/case/edit', {id: id}, function(res) {
        if (res.code === 1) {
            var d = res.data;
            $('#editId').val(d.id);
            $('#editTitle').val(d.title);
            $('#editClient').val(d.client);
...
$('#editForm').on('submit', function(e) {
    e.preventDefault();
    var id = $('#editId').val();
    var url = id ? '/admin/case/update' : '/admin/case/save';
